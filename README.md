...
* config/.pyenv/root: https://github.com/yyuu/pyenv.git (tag: v2.4.7)
* config/.pyenv/pyenv-virtualenv: https://github.com/yyuu/pyenv-virtualenv.git (tag: v1.2.3)
* config/.rbenv/root: https://github.com/rbenv/rbenv.git (tag: v1.3.0)
* config/.rbenv/ruby-build: https://github.com/rbenv/ruby-build.git (tag: v20240709.1)
